...
@section('header_title', 'Editar Alerta de Cumplimiento')
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <x-text-input id="alert_date" name="alert_date" type="date" class="w-full rounded-xl" value="{{ old('alert_date', $alert->alert_date->format('Y-m-d')) }}" required />
                    ...
                    <div>
                        ...
                        <x-text-input id="notification_days_before" name="notification_days_before" type="number" class="w-full rounded-xl" value="{{ old('notification_days_before', $alert->notification_days_before) }}" min="0" max="365" />
                ...
                <div class="pt-6">
                    <button type="submit" class="w-full bg-green-500 text-slate-900 font-bold py-4 rounded-2xl hover:bg-green-400 transition shadow-lg shadow-green-100">
                        Actualizar Alerta de Cumplimiento
                    </button>
                </div>
