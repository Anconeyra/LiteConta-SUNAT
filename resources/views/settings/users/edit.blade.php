        ...
        <form action="{{ route('settings.users.update', $user) }}" method="POST">
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <x-text-input id="name" name="name" type="text" class="w-full rounded-xl" value="{{ old('name', $user->name) }}" required />
                </div>

                <div>
                    <x-input-label for="email" value="Email" class="font-bold text-xs uppercase text-slate-400 mb-2" />
                    <x-text-input id="email" name="email" type="email" class="w-full rounded-xl" value="{{ old('email', $user->email) }}" required />
                </div>
                ...
                <div>
                    <x-input-label for="password" value="Nueva Contraseña (Opcional)" class="font-bold text-xs uppercase text-slate-400 mb-2" />
                    <x-text-input id="password" name="password" type="password" class="w-full rounded-xl" placeholder="Dejar vacío para mantener la actual" />
                ...
                <div>
                    ...
                    <x-text-input id="password_confirmation" name="password_confirmation" type="password" class="w-full rounded-xl" />
                </div>
