...
@section('header_title', 'Crear Nueva Alerta')
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="date" name="alert_date" value="{{ old('alert_date') }}" class="w-full border-gray-200 rounded-xl focus:ring-green-500" required>
                    ...
                    <div>
                        ...
                        <input type="number" name="notification_days_before" value="{{ old('notification_days_before', 0) }}" min="0" max="365" class="w-full border-gray-200 rounded-xl focus:ring-green-500">
                ...
                <div>
                    ...
                    <label class="inline-flex items-center">
                        ...
                        <input type="checkbox" name="is_active" value="1" class="rounded text-green-600 focus:ring-green-500" {{ old('is_active', true) ? 'checked' : '' }}>
